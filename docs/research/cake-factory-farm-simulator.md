...
- Milk and butter come from dairy. The simulator models a low-friction pet-store livestock counter for getting one guest cow, intake ration/water/released bedding/labor checks, transport ETA, a 1-hour supervised dairy stay and release back into the wild without removing the deeper dairy care model: pasture health, lactating cows, days in milk, dry-matter intake, rumen pH, body condition score, milk urea nitrogen, raw milk collection, bulk-tank agitation/cooling load, bulk-tank QA, HTST pasteurization/homogenization into QA-released recipe milk, cream separation, skim milk, cream pasteurization/holding/cooling, butter churning/washing/working, butter fat/moisture/salt QA, and separate raw milk, pasteurized milk and butter inventories.
...
- Vanilla and cocoa are flavoring inputs. Vanilla is represented as a greenhouse crop because commercial vanilla requires managed flowering, pollination/curing, and a long supply chain; cocoa is modeled as a small greenhouse/import crop that must be harvested into fermented, dried bean lots before the cocoa line can roast, crack, winnow, mill nibs, press cocoa butter, pin-mill powder, check fat/moisture/grind QA and release the cocoa lot.
- Baking powder and salt are not farm outputs, so they are represented as factory-made outputs from finite mineral/dry-store feedstocks. The salt works tracks audited brine lots, brine salinity/hardness/turbidity, clarification, vacuum evaporation, crystallization, centrifuge spin, dryer temperature, moisture, purity, screen passing, brine blowdown, QA hold and salt inventory. Baking soda is not treated as a supplier-ready finished input either: the baking-soda plant carbonates raw soda ash feedstock, crystallizes sodium bicarbonate, centrifuges, dries, sieves, checks alkalinity/purity/moisture and holds the lot for QA before leavening can use it. The baking-powder plant then tracks released baking soda, audited phosphate and released starch lots, phosphate acid value, dehumidified dry blending, sifter load, dust collector pressure, blend moisture, homogeneity, leavening dust, QA hold and baking-powder inventory.
- Coded cartons are not treated as finished supplier inputs. The simulator models a packaging plant fed by paperboard, label stock, packaging ink and adhesive, with board caliper/moisture, unwind tension, scoring, die cutting, blank stripping, forming, glue bead, label registration, code-vision QA, trim/matrix scrap and lab release before batching can consume cartons.
