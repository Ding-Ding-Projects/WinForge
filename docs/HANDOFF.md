...
- Corrective branch proof: commit `53da21446a5c2cded97e1387f3e36f557770a3c5` passed run `29673965179` and published `native-v1.0.47` with official Node 24 actions and exactly two native assets. Its old noncurrent check passed while observing managed Latest, so it does not prove the invariant. Exact amended branch/main run IDs, tags, and SHAs remain pending; do not claim automatic enforcement yet.
