...
**EN â€”** Volume Mixer is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** éŸ³é‡æ··åˆå™¨ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/media-capture/mixer/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [SetDefaultBtn](../../buttons/media-capture/mixer/002-setdefaultbtn.md) | `Button` | `SetDefaultBtn` | `SetDefault_Click` |