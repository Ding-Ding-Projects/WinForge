...
**EN â€”** ZoomIt is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** èž¢å¹•æ”¾å¤§èˆ‡æ¨™è¨» å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [ZoomBtn](../../buttons/media-capture/zoomit/001-zoombtn.md) | `Button` | `ZoomBtn` | `ZoomBtn_Click` |
| [DrawBtn](../../buttons/media-capture/zoomit/002-drawbtn.md) | `Button` | `DrawBtn` | `DrawBtn_Click` |
| [BreakBtn](../../buttons/media-capture/zoomit/003-breakbtn.md) | `Button` | `BreakBtn` | `BreakBtn_Click` |
| [SaveBtn](../../buttons/media-capture/zoomit/004-savebtn.md) | `Button` | `SaveBtn` | `SaveBtn_Click` |