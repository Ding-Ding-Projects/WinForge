...
|---|---|---|---|
| [AddButton](../../buttons/time-dates/countdownevent/001-addbutton.md) | `Button` | `AddButton` | `Add_Click` |
| [[icon U+E74D]](../../buttons/time-dates/countdownevent/002-delete-click.md) | `Button` | `` | `Delete_Click` |