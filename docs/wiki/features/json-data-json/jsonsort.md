...
|---|---|---|---|
| [SortBtn](../../buttons/json-data-json/jsonsort/001-sortbtn.md) | `Button` | `SortBtn` | `Sort_Click` |
| [CopyBtn](../../buttons/json-data-json/jsonsort/002-copybtn.md) | `Button` | `CopyBtn` | `Copy_Click` |