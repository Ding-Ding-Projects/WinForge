...
**EN —** JSON to Types is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).
...
|---|---|---|---|
| [CopyButton](../../buttons/json-data-json/jsontots/001-copybutton.md) | `Button` | `CopyButton` | `Copy_Click` |