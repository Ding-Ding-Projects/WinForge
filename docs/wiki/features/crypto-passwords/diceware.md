...
|---|---|---|---|
| [GenBtn](../../buttons/crypto-passwords/diceware/001-genbtn.md) | `Button` | `GenBtn` | `Gen_Click` |
| [CopyBtn](../../buttons/crypto-passwords/diceware/002-copybtn.md) | `Button` | `CopyBtn` | `Copy_Click` |