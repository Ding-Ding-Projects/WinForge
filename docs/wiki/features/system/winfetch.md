# System Info (Winfetch) Â· ç³»çµ±è³‡è¨Š
...
**EN â€”** System Info (Winfetch) is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** ç³»çµ±è³‡è¨Š å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/system/winfetch/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [CopyBtn](../../buttons/system/winfetch/002-copybtn.md) | `Button` | `CopyBtn` | `Copy_Click` |
| [ExportBtn](../../buttons/system/winfetch/003-exportbtn.md) | `Button` | `ExportBtn` | `Export_Click` |