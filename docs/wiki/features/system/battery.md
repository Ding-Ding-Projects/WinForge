...
**EN â€”** Battery & Thermal is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** é›»æ± èˆ‡æ•£ç†± å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [HealthBtn](../../buttons/system/battery/001-healthbtn.md) | `Button` | `HealthBtn` | `HealthReport_Click` |
| [EnergyBtn](../../buttons/system/battery/002-energybtn.md) | `Button` | `EnergyBtn` | `EnergyReport_Click` |