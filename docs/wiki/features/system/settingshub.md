# Settings & Control Panel Â· è¨­å®šèˆ‡æŽ§åˆ¶å°
...
| Button docs Â· æŒ‰éˆ•æ–‡ä»¶ | 0 |

## What It Covers Â· åŠŸèƒ½ç¯„åœ

**EN â€”** Settings & Control Panel is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** è¨­å®šèˆ‡æŽ§åˆ¶å° å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| None detected from XAML Â· XAML æœªåµæ¸¬åˆ° |  |  |  |