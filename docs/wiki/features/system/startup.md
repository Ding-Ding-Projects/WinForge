...
**EN â€”** Startup Apps is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** é–‹æ©Ÿç¨‹å¼ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/system/startup/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [Enable Â· å•Ÿç”¨](../../buttons/system/startup/002-enable-click.md) | `Button` | `` | `Enable_Click` |
| [Disable Â· åœç”¨](../../buttons/system/startup/003-disable-click.md) | `Button` | `` | `Disable_Click` |