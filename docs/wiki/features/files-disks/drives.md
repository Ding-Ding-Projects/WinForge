...
**EN â€”** Drives is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** ç£ç¢Ÿæ©Ÿ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/files-disks/drives/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [MountBtn](../../buttons/files-disks/drives/002-mountbtn.md) | `Button` | `MountBtn` | `Mount_Click` |
| [DismountBtn](../../buttons/files-disks/drives/003-dismountbtn.md) | `Button` | `DismountBtn` | `Dismount_Click` |
| [CreateBtn](../../buttons/files-disks/drives/004-createbtn.md) | `Button` | `CreateBtn` | `Create_Click` |