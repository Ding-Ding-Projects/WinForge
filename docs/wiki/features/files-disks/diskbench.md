# Disk Benchmark Â· ç¡¬ç¢Ÿé€Ÿåº¦æ¸¬è©¦
...
**EN â€”** Disk Benchmark is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** ç¡¬ç¢Ÿé€Ÿåº¦æ¸¬è©¦ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [BrowseBtn](../../buttons/files-disks/diskbench/001-browsebtn.md) | `Button` | `BrowseBtn` | `Browse_Click` |
| [RunBtn](../../buttons/files-disks/diskbench/002-runbtn.md) | `Button` | `RunBtn` | `Run_Click` |
| [CancelBtn](../../buttons/files-disks/diskbench/003-cancelbtn.md) | `Button` | `CancelBtn` | `Cancel_Click` |