...
**EN â€”** Batch Rename is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** æ‰¹æ¬¡æ”¹å å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [BrowseBtn](../../buttons/files-disks/rename/001-browsebtn.md) | `Button` | `BrowseBtn` | `Browse_Click` |
| [ApplyBtn](../../buttons/files-disks/rename/002-applybtn.md) | `Button` | `ApplyBtn` | `Apply_Click` |