# Instant File Search Â· å³æ™‚æª”æ¡ˆæœå°‹
...
**EN â€”** Instant File Search is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** å³æ™‚æª”æ¡ˆæœå°‹ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/files-disks/everything/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [OpenFolderBtn](../../buttons/files-disks/everything/002-openfolderbtn.md) | `Button` | `OpenFolderBtn` | `OpenFolder_Click` |
| [CopyPathBtn](../../buttons/files-disks/everything/003-copypathbtn.md) | `Button` | `CopyPathBtn` | `CopyPath_Click` |