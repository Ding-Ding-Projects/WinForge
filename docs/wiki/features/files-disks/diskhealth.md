# Disk Health (SMART) Â· ç¡¬ç¢Ÿå¥åº·ï¼ˆSMARTï¼‰
...
| Button docs Â· æŒ‰éˆ•æ–‡ä»¶ | 1 |

## What It Covers Â· åŠŸèƒ½ç¯„åœ

**EN â€”** Disk Health (SMART) is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** ç¡¬ç¢Ÿå¥åº·ï¼ˆSMARTï¼‰ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/files-disks/diskhealth/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |