...
**EN â€”** Voice & Read-Aloud is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** èªžéŸ³æœ—è®€ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [PlayBtn](../../buttons/tweaks-input/voice/001-playbtn.md) | `Button` | `PlayBtn` | `Play_Click` |
| [StopBtn](../../buttons/tweaks-input/voice/002-stopbtn.md) | `Button` | `StopBtn` | `Stop_Click` |
| [ExportBtn](../../buttons/tweaks-input/voice/003-exportbtn.md) | `Button` | `ExportBtn` | `Export_Click` |