...
**EN â€”** FancyZones is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** è¦–çª—åˆ†å€ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [RefreshBtn](../../buttons/tweaks-input/fancyzones/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [ImportBtn](../../buttons/tweaks-input/fancyzones/002-importbtn.md) | `Button` | `ImportBtn` | `Import_Click` |
| [ExportBtn](../../buttons/tweaks-input/fancyzones/003-exportbtn.md) | `Button` | `ExportBtn` | `Export_Click` |