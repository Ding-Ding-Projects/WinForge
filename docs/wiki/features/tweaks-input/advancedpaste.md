...
**EN â€”** Advanced Paste is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** é€²éšŽè²¼ä¸Š å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [PreviewBtn](../../buttons/tweaks-input/advancedpaste/001-previewbtn.md) | `Button` | `PreviewBtn` | `Preview_Click` |
| [CopyResultBtn](../../buttons/tweaks-input/advancedpaste/002-copyresultbtn.md) | `Button` | `CopyResultBtn` | `CopyResult_Click` |