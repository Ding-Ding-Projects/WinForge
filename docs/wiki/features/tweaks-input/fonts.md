...
**EN â€”** Font Manager is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** å­—åž‹ç®¡ç† å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [BrowseBtn](../../buttons/tweaks-input/fonts/001-browsebtn.md) | `Button` | `BrowseBtn` | `Browse_Click` |
| [RefreshBtn](../../buttons/tweaks-input/fonts/002-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |