# Taskbar Tweaker Â· å·¥ä½œåˆ—èª¿æ ¡
...
| Button docs Â· æŒ‰éˆ•æ–‡ä»¶ | 2 |

## What It Covers Â· åŠŸèƒ½ç¯„åœ

**EN â€”** Taskbar Tweaker is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** å·¥ä½œåˆ—èª¿æ ¡ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [WindhawkInstallHost](../../buttons/tweaks-input/taskbar/001-windhawkinstallhost.md) | `Button` | `WindhawkInstallHost` | `` |
| [RestartExplorerBtn](../../buttons/tweaks-input/taskbar/002-restartexplorerbtn.md) | `Button` | `RestartExplorerBtn` | `RestartExplorer_Click` |