...
**EN â€”** Windhawk Mods is registered in WinForge search and navigation with these keywords: $(System.Collections.Specialized.OrderedDictionary["Keywords"]).

**ç²µèªž â€”** Windhawk æ¨¡çµ„ å·²ç™»è¨˜å–º WinForge æœå°‹åŒå°Žè¦½ï¼Œé—œéµå­—åŒ…æ‹¬ï¼š$(System.Collections.Specialized.OrderedDictionary["Keywords"])ã€‚

## Buttons And Controls Â· æŒ‰éˆ•èˆ‡æŽ§åˆ¶é …

| Button Â· æŒ‰éˆ• | Type Â· é¡žåž‹ | XAML name Â· åç¨± | Handler Â· è™•ç†å‡½å¼ |
|---|---|---|---|
| [LaunchBtn](../../buttons/tweaks-input/windhawk/001-launchbtn.md) | `Button` | `LaunchBtn` | `Launch_Click` |
| [ModsFolderBtn](../../buttons/tweaks-input/windhawk/002-modsfolderbtn.md) | `Button` | `ModsFolderBtn` | `ModsFolder_Click` |
| [SiteBtn](../../buttons/tweaks-input/windhawk/003-sitebtn.md) | `Button` | `SiteBtn` | `Site_Click` |