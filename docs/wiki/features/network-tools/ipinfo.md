...
|---|---|---|---|
| [RefreshBtn](../../buttons/network-tools/ipinfo/001-refreshbtn.md) | `Button` | `RefreshBtn` | `Refresh_Click` |
| [CopyBtn](../../buttons/network-tools/ipinfo/002-copybtn.md) | `Button` | `CopyBtn` | `Copy_Click` |