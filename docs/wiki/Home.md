...
**EN —** WinForge is a fully bilingual Windows 11 control center with 139 registered in-app modules, a large tweak catalog, and a flagship nuclear-reactor simulator.
**粵語 —** WinForge 係全程雙語嘅 Windows 11 控制中心，有 139 個已登記 app 內模組、大型調校目錄，同旗艦核反應堆模擬器。
