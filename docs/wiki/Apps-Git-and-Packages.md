...
HTML5 reactor-powered cake factory and ingredient farm simulator with manual harvest, ingredient conversion, HACCP release gates, tunnel baking, cooling, icing, packaging, QA and CIP sanitation. · 以 HTML5 製作、由反應堆供電嘅蛋糕工廠與原料農場模擬器，包含手動收成、原料轉換、HACCP 放行關卡、隧道焗爐、冷卻、裝飾、包裝、品檢同 CIP 清潔。
