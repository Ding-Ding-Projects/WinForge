# Force dismount Â· å¼·åˆ¶å¸è¼‰ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **WinForge Vault**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **WinForge ä¿éšªåº«** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [WinForge Vault Â· WinForge ä¿éšªåº«](../../../features/security-privacy/vault.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Force dismount Â· å¼·åˆ¶å¸è¼‰ |
