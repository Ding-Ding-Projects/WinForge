# BackToReactorButton Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Reactor Settings**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **åæ‡‰å †è¨­å®š** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Reactor Settings Â· åæ‡‰å †è¨­å®š](../../../features/system/reactorsettings.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | BackToReactorButton |
