...
**EN â€”** Action/control documented from the WinUI XAML source for **Nmap Scanner**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç¶²çµ¡æŽƒæ** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Nmap Scanner Â· ç¶²çµ¡æŽƒæ](../../../features/system/nmap.md) |
