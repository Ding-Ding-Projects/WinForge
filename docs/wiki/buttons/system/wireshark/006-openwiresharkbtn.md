# OpenWiresharkBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Packet Capture**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å°åŒ…æ“·å–** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Packet Capture Â· å°åŒ…æ“·å–](../../../features/system/wireshark.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | OpenWiresharkBtn |
