...
**EN â€”** Action/control documented from the WinUI XAML source for **Registry Editor**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç™»éŒ„ç·¨è¼¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Registry Editor Â· ç™»éŒ„ç·¨è¼¯å™¨](../../../features/system/regedit.md) |
