...
**EN â€”** Action/control documented from the WinUI XAML source for **System Info (Winfetch)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç³»çµ±è³‡è¨Š** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [System Info (Winfetch) Â· ç³»çµ±è³‡è¨Š](../../../features/system/winfetch.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RefreshBtn |
