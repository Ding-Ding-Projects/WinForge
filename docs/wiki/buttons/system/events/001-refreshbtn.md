...
**EN â€”** Action/control documented from the WinUI XAML source for **Event Viewer**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **äº‹ä»¶æª¢è¦–å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Event Viewer Â· äº‹ä»¶æª¢è¦–å™¨](../../../features/system/events.md) |
