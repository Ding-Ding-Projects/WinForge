...
**EN â€”** Action/control documented from the WinUI XAML source for **Batch Rename**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æ‰¹æ¬¡æ”¹å** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Batch Rename Â· æ‰¹æ¬¡æ”¹å](../../../features/files-disks/rename.md) |
