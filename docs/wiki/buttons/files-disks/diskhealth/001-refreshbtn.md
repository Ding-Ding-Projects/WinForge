...
**EN â€”** Action/control documented from the WinUI XAML source for **Disk Health (SMART)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç¡¬ç¢Ÿå¥åº·ï¼ˆSMARTï¼‰** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Disk Health (SMART) Â· ç¡¬ç¢Ÿå¥åº·ï¼ˆSMARTï¼‰](../../../features/files-disks/diskhealth.md) |
