# RefreshDisksBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **TestDisk / PhotoRec Recovery**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **TestDisk / PhotoRec è³‡æ–™æ•‘æ´** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [TestDisk / PhotoRec Recovery Â· TestDisk / PhotoRec è³‡æ–™æ•‘æ´](../../../features/files-disks/testdisk.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RefreshDisksBtn |
