# Previous difference Â· ä¸Šä¸€è™•å·®ç•° Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Diff & Merge (WinMerge)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æ¯”å°èˆ‡åˆä½µ** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Diff & Merge (WinMerge) Â· æ¯”å°èˆ‡åˆä½µ](../../../features/files-disks/diff.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Previous difference Â· ä¸Šä¸€è™•å·®ç•° |
