...
**EN â€”** Action/control documented from the WinUI XAML source for **Peek**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å¿«é€Ÿé è¦½** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Peek Â· å¿«é€Ÿé è¦½](../../../features/files-disks/peek.md) |
