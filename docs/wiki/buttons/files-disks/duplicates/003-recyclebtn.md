...
**EN â€”** Action/control documented from the WinUI XAML source for **Duplicate Finder**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **é‡è¤‡æª”æ¡ˆæœå°‹** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Duplicate Finder Â· é‡è¤‡æª”æ¡ˆæœå°‹](../../../features/files-disks/duplicates.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RecycleBtn |
