# ApplyThresholdBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **OneDrive**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **OneDrive** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [OneDrive Â· OneDrive](../../../features/files-disks/onedrive.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | ApplyThresholdBtn |
