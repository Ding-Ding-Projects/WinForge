# HorizontalBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Screen Ruler**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **èž¢å¹•é–“å°º** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Screen Ruler Â· èž¢å¹•é–“å°º](../../../features/media-capture/screenruler.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | HorizontalBtn |
