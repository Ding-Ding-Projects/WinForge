...
**EN â€”** Action/control documented from the WinUI XAML source for **Activity Timeline**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æ´»å‹•æ™‚é–“è»¸** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Activity Timeline Â· æ´»å‹•æ™‚é–“è»¸](../../../features/media-capture/timelens.md) |
