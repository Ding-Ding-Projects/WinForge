# OcrRegionBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Capture Studio**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æ“·å–å·¥ä½œå®¤** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Capture Studio Â· æ“·å–å·¥ä½œå®¤](../../../features/media-capture/capture.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | OcrRegionBtn |
