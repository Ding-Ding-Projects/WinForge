# FrameRightBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Pixel Editor**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **åƒç´ ç•«ç·¨è¼¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Pixel Editor Â· åƒç´ ç•«ç·¨è¼¯å™¨](../../../features/media-capture/pixeleditor.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | FrameRightBtn |
