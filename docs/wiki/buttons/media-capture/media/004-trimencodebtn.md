# TrimEncodeBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Media**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **åª’é«”** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Media Â· åª’é«”](../../../features/media-capture/media.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | TrimEncodeBtn |
