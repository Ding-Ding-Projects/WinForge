# HistoryClearBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Text Extractor (OCR)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **åŽŸç”Ÿæ–‡å­—è¾¨è­˜** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Text Extractor (OCR) Â· åŽŸç”Ÿæ–‡å­—è¾¨è­˜](../../../features/media-capture/ocr.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | HistoryClearBtn |
