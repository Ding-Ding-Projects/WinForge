# CopyRgb_Click Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Color Picker**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **èž¢å¹•å–è‰²** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Color Picker Â· èž¢å¹•å–è‰²](../../../features/media-capture/colorpicker.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | CopyRgb_Click |
