# FromNamePreviewBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Audio Tagger**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **éŸ³è¨Šæ¨™ç±¤ç·¨è¼¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Audio Tagger Â· éŸ³è¨Šæ¨™ç±¤ç·¨è¼¯å™¨](../../../features/media-capture/tags.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | FromNamePreviewBtn |
