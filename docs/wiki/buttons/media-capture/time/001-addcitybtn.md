...
**EN â€”** Action/control documented from the WinUI XAML source for **Time & Unit Tools**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æ™‚é–“èˆ‡å–®ä½å·¥å…·** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Time & Unit Tools Â· æ™‚é–“èˆ‡å–®ä½å·¥å…·](../../../features/media-capture/time.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | AddCityBtn |
