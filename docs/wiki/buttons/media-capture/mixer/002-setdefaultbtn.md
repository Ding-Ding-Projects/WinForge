...
**EN â€”** Action/control documented from the WinUI XAML source for **Volume Mixer**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **éŸ³é‡æ··åˆå™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Volume Mixer Â· éŸ³é‡æ··åˆå™¨](../../../features/media-capture/mixer.md) |
