# FlashBootBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Fastboot / Flasher**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Fastbootï¼åˆ·æ©Ÿ** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Fastboot / Flasher Â· Fastbootï¼åˆ·æ©Ÿ](../../../features/apps-git-git/fastboot.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | FlashBootBtn |
