# FeedCreditBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **AI Agents**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **AI ä»£ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [AI Agents Â· AI ä»£ç†](../../../features/apps-git-git/ai.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | FeedCreditBtn |
