# LaunchPgAdminBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Postgres Tool**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Postgres å·¥å…· / pgAdmin** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Postgres Tool Â· Postgres å·¥å…· / pgAdmin](../../../features/apps-git-git/pgadmin.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | LaunchPgAdminBtn |
