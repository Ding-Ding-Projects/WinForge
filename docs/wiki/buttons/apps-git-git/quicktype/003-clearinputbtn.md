# ClearInputBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **quicktype**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **JSON è½‰åž‹åˆ¥** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [quicktype Â· JSON è½‰åž‹åˆ¥](../../../features/apps-git-git/quicktype.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | ClearInputBtn |
