...
**EN â€”** Action/control documented from the WinUI XAML source for **ViaProxy**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Minecraft ç‰ˆæœ¬ä»£ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [ViaProxy Â· Minecraft ç‰ˆæœ¬ä»£ç†](../../../features/apps-git-git/viaproxy.md) |
