# Pause / Unpause Â· æš«åœï¼ç¹¼çºŒ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Docker over SSH**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **é€éŽ SSH æŽ§åˆ¶ Docker** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Docker over SSH Â· é€éŽ SSH æŽ§åˆ¶ Docker](../../../features/apps-git-git/dockerssh.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Pause / Unpause Â· æš«åœï¼ç¹¼çºŒ |
