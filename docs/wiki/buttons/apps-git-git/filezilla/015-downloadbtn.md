# Download selected Â· ä¸‹è¼‰æ‰€é¸ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **FTP / SFTP**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **FTPï¼SFTP æª”æ¡ˆå‚³è¼¸** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [FTP / SFTP Â· FTPï¼SFTP æª”æ¡ˆå‚³è¼¸](../../../features/apps-git-git/filezilla.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Download selected Â· ä¸‹è¼‰æ‰€é¸ |
