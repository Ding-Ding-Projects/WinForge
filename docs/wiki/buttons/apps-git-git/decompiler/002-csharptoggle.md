# CSharpToggle Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **.NET Decompiler**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **.NET åç·¨è­¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [.NET Decompiler Â· .NET åç·¨è­¯å™¨](../../../features/apps-git-git/decompiler.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | CSharpToggle |
