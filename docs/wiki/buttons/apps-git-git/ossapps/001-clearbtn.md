...
**EN â€”** Action/control documented from the WinUI XAML source for **Native OSS Clones**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **é–‹æºåŽŸç”Ÿåˆ†é ** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Native OSS Clones Â· é–‹æºåŽŸç”Ÿåˆ†é ](../../../features/apps-git-git/ossapps.md) |
