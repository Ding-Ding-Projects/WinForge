# Save to collection Â· å„²å­˜åˆ°é›†åˆ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **API Client**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **REST API ç”¨æˆ¶ç«¯** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [API Client Â· REST API ç”¨æˆ¶ç«¯](../../../features/apps-git-git/api.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Save to collection Â· å„²å­˜åˆ°é›†åˆ |
