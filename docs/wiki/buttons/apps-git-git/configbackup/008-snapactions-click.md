# SnapActions_Click Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Config & Backup**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **è¨­å®šèˆ‡å‚™ä»½** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Config & Backup Â· è¨­å®šèˆ‡å‚™ä»½](../../../features/apps-git-git/configbackup.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | SnapActions_Click |
