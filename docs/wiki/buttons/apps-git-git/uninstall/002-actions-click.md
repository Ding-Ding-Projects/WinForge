...
**EN â€”** Action/control documented from the WinUI XAML source for **App Uninstaller**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æ‡‰ç”¨ç¨‹å¼è§£é™¤å®‰è£** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [App Uninstaller Â· æ‡‰ç”¨ç¨‹å¼è§£é™¤å®‰è£](../../../features/apps-git-git/uninstall.md) |
