# InstalledOnlyToggle Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Android Emulator & SDK**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Android æ¨¡æ“¬å™¨èˆ‡ SDK** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Android Emulator & SDK Â· Android æ¨¡æ“¬å™¨èˆ‡ SDK](../../../features/apps-git-git/emulator.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | InstalledOnlyToggle |
