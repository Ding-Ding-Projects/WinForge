# KeyFileClearBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **KeePass Vault**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å¯†ç¢¼ä¿éšªåº«** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [KeePass Vault Â· å¯†ç¢¼ä¿éšªåº«](../../../features/apps-git-git/keepass.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | KeyFileClearBtn |
