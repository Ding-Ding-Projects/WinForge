# LiveTermConnectBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **SSH Toolset**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **SSH å·¥å…·** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [SSH Toolset Â· SSH å·¥å…·](../../../features/apps-git-git/ssh.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | LiveTermConnectBtn |
