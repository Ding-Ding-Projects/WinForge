# Send to back Â· ç§»åˆ°æœ€å¾Œ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Diagram Editor**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **åœ–è¡¨ç·¨è¼¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Diagram Editor Â· åœ–è¡¨ç·¨è¼¯å™¨](../../../features/apps-git-git/diagram.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Send to back Â· ç§»åˆ°æœ€å¾Œ |
