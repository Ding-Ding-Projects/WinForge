# binding:DisconnectLabel Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **VPN & Mesh**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **VPN èˆ‡ç¶²ç‹€ç¶²** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [VPN & Mesh Â· VPN èˆ‡ç¶²ç‹€ç¶²](../../../features/apps-git-git/vpn.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | binding:DisconnectLabel |
