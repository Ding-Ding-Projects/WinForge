# SpeedLimitsBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **qBittorrent**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç¨®å­ä¸‹è¼‰** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [qBittorrent Â· ç¨®å­ä¸‹è¼‰](../../../features/apps-git-git/qbittorrent.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | SpeedLimitsBtn |
