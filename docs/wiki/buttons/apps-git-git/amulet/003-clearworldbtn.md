# ClearWorldBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Minecraft World Editor (Amulet)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Minecraft ä¸–ç•Œç·¨è¼¯å™¨ï¼ˆAmuletï¼‰** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Minecraft World Editor (Amulet) Â· Minecraft ä¸–ç•Œç·¨è¼¯å™¨ï¼ˆAmuletï¼‰](../../../features/apps-git-git/amulet.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | ClearWorldBtn |
