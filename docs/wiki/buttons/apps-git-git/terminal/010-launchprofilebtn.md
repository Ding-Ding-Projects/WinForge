# LaunchProfileBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Windows Terminal**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Windows çµ‚ç«¯æ©Ÿ** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Windows Terminal Â· Windows çµ‚ç«¯æ©Ÿ](../../../features/apps-git-git/terminal.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | LaunchProfileBtn |
