# RemoveFeedBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Feed Reader**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **RSS é–±è®€å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Feed Reader Â· RSS é–±è®€å™¨](../../../features/apps-git-git/rss.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RemoveFeedBtn |
