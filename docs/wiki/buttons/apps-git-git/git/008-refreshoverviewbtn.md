# RefreshOverviewBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Git & GitHub**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Git èˆ‡ GitHub** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Git & GitHub Â· Git èˆ‡ GitHub](../../../features/apps-git-git/git.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RefreshOverviewBtn |
