# ExportResultBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **SQLite Browser**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **SQLite è³‡æ–™åº«ç€è¦½å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [SQLite Browser Â· SQLite è³‡æ–™åº«ç€è¦½å™¨](../../../features/apps-git-git/sqlite.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | ExportResultBtn |
