# SecondaryActionBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Package Manager**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å¥—ä»¶ç®¡ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Package Manager Â· å¥—ä»¶ç®¡ç†](../../../features/apps-git-git/packages.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | SecondaryActionBtn |
