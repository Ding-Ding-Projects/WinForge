# KeybindingsBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **VS Code**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **VS Code ç·¨è¼¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [VS Code Â· VS Code ç·¨è¼¯å™¨](../../../features/apps-git-git/vscode.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | KeybindingsBtn |
