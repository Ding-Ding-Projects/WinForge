# RefreshVarFilesBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Packer (Image Builder)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Packerï¼ˆæ˜ åƒå»ºç½®å™¨ï¼‰** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Packer (Image Builder) Â· Packerï¼ˆæ˜ åƒå»ºç½®å™¨ï¼‰](../../../features/apps-git-git/packer.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RefreshVarFilesBtn |
