# ComposeDownBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Docker**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Docker å®¹å™¨ç®¡ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Docker Â· Docker å®¹å™¨ç®¡ç†](../../../features/apps-git-git/docker.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | ComposeDownBtn |
