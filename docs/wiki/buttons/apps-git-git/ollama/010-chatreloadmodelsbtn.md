# Reload models Â· é‡è¼‰æ¨¡åž‹ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Ollama**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æœ¬åœ°å¤§æ¨¡åž‹** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Ollama Â· æœ¬åœ°å¤§æ¨¡åž‹](../../../features/apps-git-git/ollama.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Reload models Â· é‡è¼‰æ¨¡åž‹ |
