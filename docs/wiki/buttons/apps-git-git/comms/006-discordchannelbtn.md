# DiscordChannelBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Communications**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **é€šè¨Š** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Communications Â· é€šè¨Š](../../../features/apps-git-git/comms.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | DiscordChannelBtn |
