# Providers & Ollama models Â· ä¾›æ‡‰å•†èˆ‡ Ollama æ¨¡åž‹ Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **AI Chat**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **AI èŠå¤©** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [AI Chat Â· AI èŠå¤©](../../../features/apps-git-git/aichat.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Providers & Ollama models Â· ä¾›æ‡‰å•†èˆ‡ Ollama æ¨¡åž‹ |
