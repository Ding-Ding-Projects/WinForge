# RefreshProfilesBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **AWS CLI**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **AWS å‘½ä»¤åˆ—** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [AWS CLI Â· AWS å‘½ä»¤åˆ—](../../../features/apps-git-git/aws.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RefreshProfilesBtn |
