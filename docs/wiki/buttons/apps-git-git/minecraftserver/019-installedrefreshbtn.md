# InstalledRefreshBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Minecraft Server**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Minecraft ä¼ºæœå™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Minecraft Server Â· Minecraft ä¼ºæœå™¨](../../../features/apps-git-git/minecraftserver.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | InstalledRefreshBtn |
