# param($m) "[icon U+$($m.Groups[1].Value.ToUpperInvariant())]" Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **VirtualBox Manager**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **VirtualBox ç®¡ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [VirtualBox Manager Â· VirtualBox ç®¡ç†](../../../features/apps-git-git/virtualbox.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | param($m) "[icon U+$($m.Groups[1].Value.ToUpperInvariant())]" |
