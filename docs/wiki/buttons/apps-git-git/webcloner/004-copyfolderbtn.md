# CopyFolderBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Website Cloner**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç¶²ç«™è¤‡è£½å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Website Cloner Â· ç¶²ç«™è¤‡è£½å™¨](../../../features/apps-git-git/webcloner.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | CopyFolderBtn |
