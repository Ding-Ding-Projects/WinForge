# DetailRefreshBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Proxmox VE**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Proxmox VE è™›æ“¬åŒ–** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Proxmox VE Â· Proxmox VE è™›æ“¬åŒ–](../../../features/apps-git-git/proxmox.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | DetailRefreshBtn |
