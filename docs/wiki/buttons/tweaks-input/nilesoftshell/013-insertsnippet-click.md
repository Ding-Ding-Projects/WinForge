# binding:InsertLabel Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Nilesoft Shell**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Nilesoft å³éµé¸å–®** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Nilesoft Shell Â· Nilesoft å³éµé¸å–®](../../../features/tweaks-input/nilesoftshell.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | binding:InsertLabel |
