# RegenKeyBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Mouse Without Borders**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **ç„¡ç•Œæ»‘é¼ ** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Mouse Without Borders Â· ç„¡ç•Œæ»‘é¼ ](../../../features/tweaks-input/mwb.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RegenKeyBtn |
