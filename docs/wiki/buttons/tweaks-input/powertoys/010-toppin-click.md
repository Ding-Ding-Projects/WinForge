# binding:PinLabel Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **PowerToys Extras**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **PowerToys é¡å¤–å·¥å…·** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [PowerToys Extras Â· PowerToys é¡å¤–å·¥å…·](../../../features/tweaks-input/powertoys.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | binding:PinLabel |
