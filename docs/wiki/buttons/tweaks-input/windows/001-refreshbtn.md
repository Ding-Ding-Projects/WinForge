...
**EN â€”** Action/control documented from the WinUI XAML source for **Window Manager**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **è¦–çª—ç®¡ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Window Manager Â· è¦–çª—ç®¡ç†](../../../features/tweaks-input/windows.md) |
