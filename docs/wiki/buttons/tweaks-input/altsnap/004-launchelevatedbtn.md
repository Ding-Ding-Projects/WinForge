# LaunchElevatedBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **AltSnap**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Alt æ‹–æ›³è¦–çª—** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [AltSnap Â· Alt æ‹–æ›³è¦–çª—](../../../features/tweaks-input/altsnap.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | LaunchElevatedBtn |
