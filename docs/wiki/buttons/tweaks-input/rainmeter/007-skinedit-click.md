# Edit ini Â· ç·¨è¼¯ ini Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Rainmeter Widgets**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Rainmeter æ¡Œé¢å°å·¥å…·** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Rainmeter Widgets Â· Rainmeter æ¡Œé¢å°å·¥å…·](../../../features/tweaks-input/rainmeter.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Edit ini Â· ç·¨è¼¯ ini |
