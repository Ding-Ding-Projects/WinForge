...
**EN â€”** Action/control documented from the WinUI XAML source for **FancyZones**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **è¦–çª—åˆ†å€** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [FancyZones Â· è¦–çª—åˆ†å€](../../../features/tweaks-input/fancyzones.md) |
