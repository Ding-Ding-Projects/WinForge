...
**EN â€”** Action/control documented from the WinUI XAML source for **Hosts Editor**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **hosts ç·¨è¼¯å™¨** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Hosts Editor Â· hosts ç·¨è¼¯å™¨](../../../features/tweaks-input/hosts.md) |
