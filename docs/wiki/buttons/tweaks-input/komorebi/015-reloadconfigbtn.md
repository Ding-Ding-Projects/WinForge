# ReloadConfigBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Komorebi (Tiling WM)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **Komorebi å¹³é‹ªè¦–çª—ç®¡ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Komorebi (Tiling WM) Â· Komorebi å¹³é‹ªè¦–çª—ç®¡ç†](../../../features/tweaks-input/komorebi.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | ReloadConfigBtn |
