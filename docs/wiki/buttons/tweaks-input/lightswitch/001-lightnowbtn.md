# LightNowBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **LightSwitch (Auto Dark Mode)**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **è‡ªå‹•æ·±æ·ºè‰²** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [LightSwitch (Auto Dark Mode) Â· è‡ªå‹•æ·±æ·ºè‰²](../../../features/tweaks-input/lightswitch.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | LightNowBtn |
