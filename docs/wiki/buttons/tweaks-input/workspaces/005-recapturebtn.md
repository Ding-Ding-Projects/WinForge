# RecaptureBtn Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Workspaces**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å·¥ä½œå€** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Workspaces Â· å·¥ä½œå€](../../../features/tweaks-input/workspaces.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RecaptureBtn |
