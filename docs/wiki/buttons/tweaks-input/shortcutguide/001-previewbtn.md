...
**EN â€”** Action/control documented from the WinUI XAML source for **Shortcut Guide**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å¿«æ·éµæŒ‡å—** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Shortcut Guide Â· å¿«æ·éµæŒ‡å—](../../../features/tweaks-input/shortcutguide.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | PreviewBtn |
