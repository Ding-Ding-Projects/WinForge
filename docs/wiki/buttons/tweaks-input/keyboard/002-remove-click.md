# Remove_Click Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Keyboard Remapper**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **éµç›¤é‡æ–°å°æ‡‰** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Keyboard Remapper Â· éµç›¤é‡æ–°å°æ‡‰](../../../features/tweaks-input/keyboard.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | Remove_Click |
