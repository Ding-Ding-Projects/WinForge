...
**EN â€”** Action/control documented from the WinUI XAML source for **Voice & Read-Aloud**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **èªžéŸ³æœ—è®€** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Voice & Read-Aloud Â· èªžéŸ³æœ—è®€](../../../features/tweaks-input/voice.md) |
