# OpenNowButton Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **Command Palette**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **æŒ‡ä»¤é¢æ¿** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Command Palette Â· æŒ‡ä»¤é¢æ¿](../../../features/tweaks-input/cmdpalette.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | OpenNowButton |
