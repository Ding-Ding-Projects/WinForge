...
**EN â€”** Action/control documented from the WinUI XAML source for **Context Menu**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å³éµé¸å–®** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Context Menu Â· å³éµé¸å–®](../../../features/tweaks-input/contextmenu.md) |
