# RemoveWorkspace_Click Â· Button

**EN â€”** Action/control documented from the WinUI XAML source for **GlazeWM Tiling**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **GlazeWM å¹³é‹ªè¦–çª—** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [GlazeWM Tiling Â· GlazeWM å¹³é‹ªè¦–çª—](../../../features/tweaks-input/glazewm.md) |
...
| Label / tooltip Â· æ¨™ç±¤ï¼æç¤º | RemoveWorkspace_Click |
