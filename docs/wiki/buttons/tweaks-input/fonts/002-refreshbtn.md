...
**EN â€”** Action/control documented from the WinUI XAML source for **Font Manager**.
**ç²µèªž â€”** å‘¢å€‹å‹•ä½œï¼æŽ§åˆ¶é …ä¿‚ç”± **å­—åž‹ç®¡ç†** å˜… WinUI XAML ä¾†æºæ•´ç†å‡ºåšŸã€‚

| Field Â· æ¬„ä½ | Value Â· å€¼ |
|---|---|
| Module Â· æ¨¡çµ„ | [Font Manager Â· å­—åž‹ç®¡ç†](../../../features/tweaks-input/fonts.md) |
