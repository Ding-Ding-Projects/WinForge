...
| Churn butter · 打牛油 | Converts raw milk/cream into butter through cream separation, cream pasteurization, churning and cold-room transfer. |
...
5. Prepare ingredients manually:
   ...
   - Churn butter when raw milk inventory has enough reserve and wait for the separator/churn run.
