...
All outputs are staged before promotion; file paths use argument vectors rather than a command shell; batches and chapter sets are bounded; and Cancel terminates the owned process and cleans owned scratch files. Full behavior, limits, failure modes, and 17-case verification are in the [Guided Media studio workflow guide](https://github.com/Ding-Ding-Projects/WinForge/blob/main/docs/features/media-capture/media-studio-workflows.md).
