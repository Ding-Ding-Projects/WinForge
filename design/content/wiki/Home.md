...
| [Managed Regex Builder](#/wiki/Regex-Builder) | Guided .NET construction, thirteen builder-backed searches, a 102-control inventory, bounded live matches/captures, and safety evidence · 引導式 .NET 砌法、十三個已接 builder 嘅搜尋、102 控制清單、有界即時配對／擷取同安全證據 |
| [Notification Centre](#/wiki/Notification-Centre) | Stacked non-blocking notices, actions, and reviewable local history · 堆疊式非阻塞通知、動作同可翻查本機記錄 |
...
- [No-Redirect Audit](#/wiki/No-Redirect-Audit) · 無跳轉審核
