...
Behavior, failure modes, safety boundaries, and focused verification: [Screen Recorder lifecycle reliability](https://github.com/Ding-Ding-Projects/WinForge/blob/main/docs/features/media/screen-recorder.md). · 行為、失敗模式、安全界線同專項驗證請睇 [螢幕錄影 lifecycle 可靠性](https://github.com/Ding-Ding-Projects/WinForge/blob/main/docs/features/media/screen-recorder.md)。
