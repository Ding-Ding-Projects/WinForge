...
| Debug / Release core tests · Debug／Release 核心測試 | **389/389** each (343 core + 46 parser; 42/42 focused batch-coordinator checks) · 各自 **389/389**（343 個 core + 46 個 parser；42/42 個專項批次協調器檢查） |
| Native shell accessibility smoke · 原生 shell 無障礙 smoke | **171/171** elevated process-owned UI Automation checks · **171/171** 提權、自有 process UI Automation 檢查 |
