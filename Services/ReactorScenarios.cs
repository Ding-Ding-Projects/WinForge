...
public static class ReactorScenarios
{
    ...
    public static StartupStep[] StartupSequence() => new[]
    {
        new StartupStep
        {
            ...
            DetailEn = "Step 1: choose Startup. For a first run, turn on Easy startup assist here; it only helps below 5% power and costs 1.5x fuel burn.",
            DetailZh = "第 1 步：選擇啟動。第一次玩可以喺度開「簡易啟動輔助」；只會喺低於 5% 功率時幫手，但燃料燃耗會變成 1.5 倍。",
        ...
        new StartupStep
        {
            ...
            DetailEn = "Step 4: turn Auto press ctrl and Heater ON, keep Spray OFF and Relief CLOSED, then wait for the live pressure gauge to reach 14.5 MPa / 2235 psia. In Easy Mode you may Skip step 4 if this wait stalls; trips and pressure readings are not bypassed.",
            DetailZh = "第 4 步：開啟自動壓力同加熱器，保持噴淋關、釋壓閥關，然後等即時壓力儀表到 14.5 MPa / 2235 psia。簡易模式如果卡喺呢度，可以跳過第 4 步；跳脫同壓力讀數唔會被繞過。",
            ControlTarget = "primary-system",
            ControlRoom = "contain",
        ...
        new StartupStep
        {
            ...
            DetailEn = "Step 5: make one small reactivity change, then wait. Withdraw rods by about 5-10% or lower boron in small steps; stop if period drops under 30 s or SUR rises quickly.",
            DetailZh = "第 5 步：每次只做一個細反應性調整，然後等待。控制棒每次約提 5-10%，或少量降低硼目標；如果週期低於 30 秒或起動率急升，就停止。",
        ...
        new StartupStep
        {
            ...
            DetailEn = "Step 6: watch 1/M move toward 0. If period gets short, hold rods and boron steady until the response slows.",
            DetailZh = "第 6 步：監察 1/M 趨近 0。如果週期變短，就保持棒位同硼濃度不變，等反應慢返。",
            ControlTarget = "nis",
            ControlRoom = "control",
