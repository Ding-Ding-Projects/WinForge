...
public static class OpenSourceAppHubService
{
    public static readonly NativeOssCloneInfo[] Catalog =
    {
        ...
        Clone("Dew Encryption", "Dew 加密", "Dew Encryption",
            "Security & privacy", "安全與私隱", "Keep Git-backed file history, restore safely and export encrypted 7z archives.",
            "保留 Git 檔案歷史、安全還原，同匯出加密 7z 封存。", "module.dew-encryption", "dew-encryption",
            "Native tab", "原生分頁", "Managed copy/rollback engine with hardened Git and in-process, secret-safe 7z.dll encryption.",
            "受控複製／rollback 引擎，加固 Git 同程序內唔會外洩密碼嘅 7z.dll 加密。", "dew", "encryption", "history", "7z"),
