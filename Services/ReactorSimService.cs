...
public sealed class ReactorSimService
{
    ...
    public string ExportStateJson(double clock, bool zhPrimary)
    {
        ...
        var dto = new
        {
            ...
            steamRelief = ReliefValveOpen || AnyPzrCodeSafetyOpen || MssvLifted,
            eccsArmed = EccsArmed,
            ...
            containmentPressureKpa = ContainmentPressureKpa,
            containmentTempC = ContainmentTempC,
            containmentSpray = ContainmentSprayActive,
            containmentIsolation = ContainmentIsolationPhaseA || ContainmentIsolationPhaseB,
            containmentH2Pct = ContainmentH2Pct,
            ccwFlow = CcwFlowFrac,
            ccwAvailable = CcwAvailable,
            ccwPumps = CcwPumpsRunning,
            acAvailable = Electrical.AnyAcBusEnergized,
            stationBlackout = Electrical.InSbo,
            edgPower = Electrical.OnEdgPower,
            batterySoc = Electrical.BatterySoc,
            secondaryRadiation = SecondaryRadiation,
            particulateMonitor = ParticulateMonitorRatio,
            gaseousMonitor = GaseousMonitorRatio,
