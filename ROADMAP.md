...
- [x] Reconcile eight stale core backlog sections against reachable controls and real implementation paths: Browser Control's eleven gaps are now closed, bringing the source-proven matrix to 85 of 115 shipped with 30 intentionally unchecked in the [categorized audit](docs/audits/roadmap-core-capability-audit-2026-07-24.md). · 將八個過時核心待辦章節同可達控制／真實實作逐項核對；瀏覽器控制十一個缺口已補齊，115 項有 85 項證實已交付，30 項按[分類審核](docs/audits/roadmap-core-capability-audit-2026-07-24.md)刻意保留未剔選。
