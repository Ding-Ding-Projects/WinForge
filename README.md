...
| **Cake Factory & Farm · 蛋糕工廠與農場** | HTML5 reactor-powered cake factory game with finite supplies, non-farm ingredient factories, manual HACCP gates and signed `.cake` files. <br> HTML5 反應堆供電蛋糕工廠遊戲，附有限補給、非農場原料工廠、手動 HACCP 放行關卡同已簽署 `.cake` 檔。 | `cakefactory` |
