...
public static class AnnoyanceTweaks
{
    ...
    {
        // ===== copilot-search (16) =====
        StatusToggle("annoy.copilot-off", "Turn off Windows Copilot", "熄 Windows Copilot",
        ...
        StatusToggle("annoy.recall-off", "Turn off Recall snapshots", "熄 Recall 截圖記錄",
        ...
        StatusToggle("annoy.search-box-suggestions-off", "Turn off search box web suggestions", "熄搜尋框嘅網上建議",
        ...
        StatusToggle("annoy.bing-search-off", "Turn off Bing in Start search", "熄開始搜尋嘅 Bing",
        ...
        StatusToggle("annoy.cortana-consent-off", "Turn off Cortana consent in search", "熄搜尋度嘅 Cortana 同意",
        ...
        StatusToggle("annoy.search-highlights-off", "Turn off Search Highlights", "熄搜尋焦點 (Search Highlights)",
        ...
        StatusToggle("annoy.cortana-off", "Turn off Cortana", "熄 Cortana",
        ...
        StatusToggle("annoy.search-web-off", "Turn off web search in Search", "熄搜尋度嘅網上搜尋",
        ...
        StatusToggle("annoy.disable-web-search-policy-off", "Turn off web results in Search (policy)", "用原則熄搜尋嘅網上結果",
        ...
        StatusToggle("annoy.cortana-above-lock-off", "Turn off Cortana above lock screen", "熄鎖屏上面嘅 Cortana",
        ...
        StatusToggle("annoy.edge-copilot-sidebar-off", "Turn off Edge Copilot sidebar", "熄 Edge Copilot 側欄",
        ...
        StatusToggle("annoy.edge-shopping-off", "Turn off Edge shopping assistant", "熄 Edge 購物助手",
        ...
        StatusToggle("annoy.edge-collections-off", "Turn off Edge Collections", "熄 Edge Collections",
        ...
        StatusToggle("annoy.edge-copilot-page-context-off", "Turn off Edge Copilot page context", "熄 Edge Copilot 讀取頁面內容",
        ...
        StatusToggle("annoy.remove-copilot-app", "Remove the Copilot app", "移除 Copilot app",
        ...
        // ===== ads-nags (16) =====
        StatusToggle("annoy.lockscreen-spotlight-tips-off", "Turn off lock-screen Spotlight tips", "熄鎖機畫面 Spotlight 提示",
        ...
        StatusToggle("annoy.lockscreen-funfacts-off", "Turn off lock-screen fun facts & tips", "熄鎖機畫面趣聞同貼士",
        ...
        StatusToggle("annoy.settings-suggested-393-off", "Hide suggested content in Settings (1)", "收埋設定入面嘅建議內容 (1)",
        ...
        StatusToggle("annoy.settings-suggested-694-off", "Hide suggested content in Settings (2)", "收埋設定入面嘅建議內容 (2)",
        ...
        StatusToggle("annoy.settings-suggested-696-off", "Hide suggested content in Settings (3)", "收埋設定入面嘅建議內容 (3)",
        ...
        StatusToggle("annoy.scoobe-off", "Turn off \"Get even more out of Windows\" nag", "熄「再進一步善用 Windows」嘅纏擾",
        ...
        StatusToggle("annoy.welcome-experience-off", "Skip welcome experience after updates", "更新後跳過歡迎畫面",
        ...
        StatusToggle("annoy.softlanding-off", "Turn off tips & suggestions (soft landing)", "熄提示同建議（soft landing）",
        ...
        StatusToggle("annoy.windows-tips-338389-off", "Turn off Windows tips notifications", "熄 Windows 貼士通知",
        ...
        StatusToggle("annoy.explorer-sync-ads-off", "Hide File Explorer sync-provider ads", "收埋檔案總管嘅 sync 推廣",
        ...
        StatusToggle("annoy.start-account-notifications-off", "Turn off account notifications in Start", "熄開始選單嘅帳戶通知",
        ...
        StatusToggle("annoy.start-iris-recommendations-off", "Reduce Start \"recommended\" suggestions", "減少開始選單「建議」推介",
        ...
        StatusToggle("annoy.start-suggestions-off", "Turn off Start menu app suggestions", "熄開始選單嘅 App 建議",
        ...
        StatusToggle("annoy.preinstalled-apps-off", "Stop silently installing suggested apps", "唔好靜雞雞裝建議 App",
        ...
        StatusToggle("annoy.contentdelivery-master-off", "Turn off general content suggestions", "熄一般內容建議",
        ...
        StatusToggle("annoy.consumer-features-off", "Disable Windows consumer features", "停用 Windows 消費者功能",
        ...
        StatusToggle("annoy.settings-hide-home", "Hide the Settings homepage", "隱藏設定首頁",
    ...
    /// <summary>
    /// 同 <see cref="Tweak.RegToggle"/> 行為完全一致嘅登錄檔開關，但額外掛一個彩色狀態藥丸：
    /// 綠色「已停用」表示個煩擾已被中和，黃色「仍開啟」表示尚未生效。
    /// A registry-backed toggle behaving identically to <see cref="Tweak.RegToggle"/> (same Id, path,
    /// values, kind, admin/restart scope and get/set wiring), plus a coloured status pill so the user
    /// can tell at a glance whether the annoyance is already neutralised — green "Disabled · 已停用"
    /// when the desired (on) state is set, amber "Still on · 仍開啟" otherwise.
    /// </summary>
    private static TweakDefinition StatusToggle(
    ...
    {
        bool IsNeutralised() => RegistryHelper.ValueEquals(root, path, name, onValue);
        ...
        return new TweakDefinition
        {
            ...
            ColoredStatus = () => IsNeutralised()
                ? ("Disabled", "已停用", StatusColor.Good)
                : ("Still on", "仍開啟", StatusColor.Warn),
        };
    }

    /// <summary>切割逗號／分號分隔嘅關鍵字，與 <see cref="Tweak"/> 工廠一致 · Split comma/semicolon keywords, matching the <see cref="Tweak"/> factory.</summary>
