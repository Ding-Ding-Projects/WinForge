...
namespace winrt::WinForge::implementation
{
    ...
    {
        if (m_currentRoute != L"module.percentcalc" || nextRoute == L"module.percentcalc") return;
    ...
    void MainWindow::Navigate(std::wstring_view route, std::wstring_view argument, bool deepLink)
    {
        ...
        {
            m_percentC1XValue.clear();
            m_percentC1YValue.clear();
            m_percentC2XValue.clear();
            m_percentC2YValue.clear();
            m_percentC3AValue.clear();
            m_percentC3BValue.clear();
            m_percentC4YValue.clear();
            m_percentC4XValue.clear();
            m_percentC5BillValue.clear();
            m_percentC5TipValue.clear();
            m_percentC5SplitValue = L"1";
            m_percentC6AValue.clear();
            m_percentC6BValue.clear();
            m_percentC1CopyValue.clear();
            m_percentC2CopyValue.clear();
            m_percentC3CopyValue.clear();
            m_percentC4CopyValue.clear();
    ...
    void MainWindow::RenderPercentCalc()
    {
        ...
        {
            auto caption = CreateText(L"Result", 13, true);
            content.Children().Append(caption);
            target = TextBox();
